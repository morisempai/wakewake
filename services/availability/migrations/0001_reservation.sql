-- 0001_reservation.sql — the anti-double-booking core (ADR-0003, amended by ADR-0008).
--
...
CREATE TABLE reservation (
  ...
  -- THE INVARIANT.
  --
  -- Partial on `status <> 'released'` (ADR-0008). ADR-0003 specified this constraint over the
...
COMMENT ON CONSTRAINT reservation_no_overlap ON reservation IS
  'ADR-0003/ADR-0008: the no-double-booking invariant. Violation surfaces as SQLSTATE 23P01 and '
